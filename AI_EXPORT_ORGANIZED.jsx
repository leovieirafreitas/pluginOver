...
(function() {
    ...
    // Função utilitária para stringify JSON (já que AI antigo não tem JSON nativo)
    ...
    alert("Vetores organizados exportados com sucesso!\nAgora rode o script de importação no After Effects.");
